...
import { selectMeta, selectOrgLoading, selectOrgs } from '@/store/organisation/selectors';

const { RangePicker } = DatePicker;

// Use imported icons instead of placeholder URLs
const AllOrgs = "/assets/icons/allCustomers.svg";
const ActiveOrgs = "/assets/icons/activeCustomers.svg";
const InactiveOrgs = "/assets/icons/inactiveCustomers.svg";
...
const Organisation: React.FC = () => {
  ...
  const organisations = useSelector(selectOrgs);
  const loading = useSelector(selectOrgLoading);
  ...
  const handleAddNewOrganisation = (): void => {
    router.push('/dashboard/organisation/add-organisation');
  };

  const handleViewOrganisation = (id: string): void => {
    router.push(`/dashboard/organisation/edit-organisation/${id}`);
  };

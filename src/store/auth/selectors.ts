...
export const selectIsTwoFaRequired = (state: RootState): boolean =>
  state.auth.isTwoFaRequired;
export const selectIsMfaLogin = (state: RootState): boolean =>
  state.auth.isMfaLogin;
export const selectQrCode = (state: RootState): string | null =>
  state.auth.qrCode;
export const selectRequiresMfa = (state: RootState): boolean =>
